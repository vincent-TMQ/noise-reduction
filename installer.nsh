!macro customInstall
  ...
  ; Check if VB-Cable is already installed using the PowerShell script
  nsExec::ExecToStack 'powershell -ExecutionPolicy Bypass -File "$INSTDIR\resources\check_vbcable.ps1"'
  Pop $0
  Pop $1
  ${If} $1 != "0"
    DetailPrint "VB-Cable device found. Skipping installation."
